...
<body>
    <div class="page-wrapper">
        ...
        <main class="main">
            ...
            <div class="login-page bg-image pt-8 pb-8 pt-md-12 pb-md-12 pt-lg-17 pb-lg-17" style="background-image: url('assets/images/backgrounds/login-background.jpg')">
            	<div class="container">
            		<div class="form-box">
            			<div class="form-tab">
							    ...
							    <div class="tab-pane fade show active" id="register-2" role="tabpanel" aria-labelledby="register-tab-2">
							    	<form action="{{route('destination.store')}}" method="POST">
                                        ...
                                        <div class="form-group">
							    			...
							    			<label for="register-email-2">Fullname</label>
							    			<input type="text" class="form-control" id="register-email-2" name="fullname" required>
							    		</div><!-- End .form-group -->
