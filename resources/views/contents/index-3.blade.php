                                ...
                                <div class="intro-slider owl-carousel owl-simple owl-dark owl-nav-inside" data-toggle="owl" data-owl-options='{
                                    ...
                                    <div class="intro-slide">
                                        ...
                                        <div class="intro-content">
                                            ...
                                            <a href="product2" class="btn btn-primary btn-round">
                    ...
                    <div class="tab-pane p-0 fade show active" id="products-featured-tab" role="tabpanel" aria-labelledby="products-featured-link">
                        <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                            ...
                            <div class="product product-2">
                             ...
                             <a class="nav-link" href="{{route('product.create')}}"> <button>Create</button></a>
                                ...
                                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                                    ...
                                    <div class="product product-2">
                                        <figure class="product-media">
                                            <span class="product-label label-circle label-new">New</span>
                                            <a href="product.html">
                                                <img src="images2/{{ $product->image }}" alt="Product image" class="product-image" height="218px" width="218px">
                                            </a>
                        ...
                        <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                            ...
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <div class="ratings-codivntainer">
                                        <div class="ratings">
                                            <div class="ratings-val" style="width: 100%;"></div><!-- End .ratings-val -->
                                        </div><!-- End .ratings -->
                                        <span class="ratings-text">( 10 Reviews )</span>
