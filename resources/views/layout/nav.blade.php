            ...
            <div class="header-top">
                <div class="container">
                    <div class="header-left">
                        <a href="tel:#"><i class="icon-phone"></i>Call: +750-217-8742</a>
                    </div><!-- End .header-left -->
                    ...
                    <div class="header-right">
                        ...
                        <ul class="top-menu">
                            <li>
                                {{-- <a href="{{route('in')}}">Links</a> --}}
                                <ul>

                                    <li><a href="" data-toggle="modal">Sign in / Sign up</a></li>
                                </ul>
                            </li>
                        </ul><!-- End .top-menu -->
                            ...
                            <div class="dropdown-menu">
                                <nav class="side-nav">
                                    <ul class="menu-vertical sf-arrows">
                                        {{-- <li><a href="{{route('category.show','phones')}}">Phones</a></li> --}}
                        ...
                        <nav class="main-nav" >
                            <ul class="menu sf-arrows">
                                <li class="megamenu-container active">
                                    <a href="/products" class="sf-with-ul">Home</a>
                                </li>
                                <li>
                                    <a href="{{route('product.index')}}" class="sf-with-ul">Products</a>
